...
SERVICES :=    srcs/billing-app srcs/api-gateway-app  #  srcs/rabbit-queue  srcs/api-gateway-app  srcs/billing-app srcs/inventory-app srcs/inventory-database srcs/billing-database  
